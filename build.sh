...
g++ -g -c modulators/lfo.cpp -o ./builds/lfo.o
...
g++ -o ./a.out ./builds/main.o ./builds/processor.o ./builds/adsr.o ./builds/lfo.o ./builds/wt.o ./builds/generator.o ./builds/tinywav.o ./builds/fft.o
./a.out $1 $2
